...
# Tableau Kaplan–Meier SANS CENSURE (variance binomiale)
...
```{r survival_without_parameters_6, echo = FALSE, }
# vecteurs concaténés
time  <- c(time1, time2)
event <- c(event1, event2)
...
```{r survival_without_parameters_7, echo = FALSE, fig.align='center'}
# --- Données
...
```{r survival_without_parameters_9, echo = FALSE, }
# vecteurs concaténés
...
```{r survival_without_parameters_99, echo = FALSE, }
# vecteurs concaténés
time  <- c(time1, time2, time3, time4)
event <- c(event1, event2, event3, event4)
...
# --- Tableau combiné Nelson-Aalen + Breslow + Variance ---
...
```{r survival_without_parameters_12, echo = FALSE, fig.align='center'}
# --- Données ---
time <- data.brute$marriage_duration_years
event <- data.brute$divorced
